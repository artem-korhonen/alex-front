...
export const songs: Song[] = [
    { id: 1, name: "Neon Night", cover: "/", path: "/", artists_ids: [1], artists: ["Nova"], listenings: "12431", is_liked: 1 },
    { id: 2, name: "City Lights", cover: "/", path: "/", artists_ids: [1, 2], artists: ["Nova", "Pulse"], listenings: "9820", is_liked: -1 },
    { id: 3, name: "Afterglow", cover: "/", path: "/", artists_ids: [2], artists: ["Pulse"], listenings: "6551", is_liked: 0 },
    { id: 4, name: "Morning Drive", cover: "/", path: "/", artists_ids: [3], artists: ["Aurora"], listenings: "3112", is_liked: -1 },
    { id: 5, name: "Ocean Echo", cover: "/", path: "/", artists_ids: [3], artists: ["Aurora"], listenings: "7904", is_liked: 1 },
    { id: 6, name: "The Deep", cover: "/", path: "/", artists_ids: [4], artists: ["Vesper"], listenings: "15200", is_liked: 1 },
    { id: 7, name: "Glass Heart", cover: "/", path: "/", artists_ids: [5], artists: ["Lumina"], listenings: "4200", is_liked: 0 },
    { id: 8, name: "Floating", cover: "/", path: "/", artists_ids: [5], artists: ["Lumina"], listenings: "890", is_liked: 0 },
    { id: 9, name: "Circuit Breach", cover: "/", path: "/", artists_ids: [6, 1], artists: ["Cortex", "Nova"], listenings: "21040", is_liked: 1 },
    { id: 10, name: "Neon Pulse", cover: "/", path: "/", artists_ids: [6], artists: ["Cortex"], listenings: "11230", is_liked: 0 },
    { id: 11, name: "Warm Rain", cover: "/", path: "/", artists_ids: [7], artists: ["Solaris"], listenings: "54300", is_liked: 1 },
    { id: 12, name: "Lo-fi Morning", cover: "/", path: "/", artists_ids: [7], artists: ["Solaris"], listenings: "32100", is_liked: 0 },

    { id: 13, name: "Midnight Signal", cover: "/", path: "/", artists_ids: [1], artists: ["Nova"], listenings: "8800", is_liked: 0 },
    { id: 14, name: "Retro Drive", cover: "/", path: "/", artists_ids: [2], artists: ["Pulse"], listenings: "7200", is_liked: 1 },
    { id: 15, name: "Northern Lights", cover: "/", path: "/", artists_ids: [3], artists: ["Aurora"], listenings: "4100", is_liked: 0 },
    { id: 16, name: "Shadow System", cover: "/", path: "/", artists_ids: [4], artists: ["Vesper"], listenings: "6100", is_liked: 0 },
    { id: 17, name: "Dream Fragments", cover: "/", path: "/", artists_ids: [5], artists: ["Lumina"], listenings: "3300", is_liked: 0 },
    { id: 18, name: "Neural Storm", cover: "/", path: "/", artists_ids: [6], artists: ["Cortex"], listenings: "14200", is_liked: 1 },
    { id: 19, name: "Lazy Sunset", cover: "/", path: "/", artists_ids: [7], artists: ["Solaris"], listenings: "28000", is_liked: 1 }
];
...
export const releases: Release[] = [
    {
        id: 1, name: "Neon Night", cover: "/", type: "single", artists: [at.nova], songs: [
            { song: songLines[0], position: 1, disk: null }
        ], is_liked: false
    },
    {
        id: 2, name: "Urban Echo", cover: "/", type: "ep", artists: [at.nova, at.pulse], songs: [
            { song: songLines[1], position: 1, disk: null },
            { song: songLines[2], position: 2, disk: null }
        ], is_liked: true
    },
    {
        id: 3, name: "Skyline Dreams", cover: "/", type: "album", artists: [at.aurora], songs: [
            { song: songLines[3], position: 1, disk: null },
            { song: songLines[4], position: 2, disk: null }
        ], is_liked: false
    },
    {
        id: 4, name: "Void", cover: "/", type: "single", artists: [at.vesper], songs: [
            { song: songLines[5], position: 1, disk: null }
        ], is_liked: true
    },
    {
        id: 5, name: "Crystal Skies", cover: "/", type: "album", artists: [at.lumina], songs: [
            { song: songLines[6], position: 1, disk: null },
            { song: songLines[7], position: 2, disk: null }
        ], is_liked: false
    },
    {
        id: 6, name: "Digital Frontier", cover: "/", type: "ep", artists: [at.cortex, at.nova], songs: [
            { song: songLines[8], position: 1, disk: null },
            { song: songLines[9], position: 2, disk: null }
        ], is_liked: true
    },
    {
        id: 7, name: "Sunsets & Coffee", cover: "/", type: "album", artists: [at.solaris], songs: [
            { song: songLines[10], position: 1, disk: null },
            { song: songLines[11], position: 2, disk: null }
        ], is_liked: true
    },
    {
        id: 8, name: "Midnight Signal", cover: "/", type: "single", artists: [at.nova], songs: [
            { song: songLines[12], position: 1, disk: null }
        ], is_liked: false
    },
    {
        id: 9, name: "Retro Wave", cover: "/", type: "ep", artists: [at.pulse], songs: [
            { song: songLines[2], position: 1, disk: null },
            { song: songLines[13], position: 2, disk: null }
        ], is_liked: false
    },
    {
        id: 10, name: "Aurora Skies", cover: "/", type: "single", artists: [at.aurora], songs: [
            { song: songLines[14], position: 1, disk: null }
        ], is_liked: true
    },
    {
        id: 11, name: "Industrial Dreams", cover: "/", type: "album", artists: [at.vesper], songs: [
            { song: songLines[5], position: 1, disk: null },
            { song: songLines[15], position: 2, disk: null }
        ], is_liked: false
    },
    {
        id: 12, name: "Soft Horizons", cover: "/", type: "ep", artists: [at.lumina], songs: [
            { song: songLines[6], position: 1, disk: null },
            { song: songLines[16], position: 2, disk: null }
        ], is_liked: true
    },
    {
        id: 13, name: "Cyber Systems", cover: "/", type: "single", artists: [at.cortex], songs: [
            { song: songLines[17], position: 1, disk: null }
        ], is_liked: false
    },
    {
        id: 14, name: "Coffee Break Beats", cover: "/", type: "ep", artists: [at.solaris], songs: [
            { song: songLines[10], position: 1, disk: null },
